...
/**
 * Inférence Gemma locale pour la critique santé (spec 002), même pile LiteRT-LM que [com.miamia.composition.LiteRtGemmaEngine].
        ...
        private val inferenceExecutor = Executors.newCachedThreadPool(
            object : ThreadFactory {
                ...
                override fun newThread(r: Runnable): Thread {
                    val t = Thread(r, "miamia-health-critique-${seq.incrementAndGet()}")
                    t.isDaemon = true
                    return t
                }
            },
