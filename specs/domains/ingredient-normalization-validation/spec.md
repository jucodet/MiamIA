...
- Texte multi-lignes sans terminateur : la capture traverse les sauts de ligne et inclut tout le texte restant jusqu'au terminateur ou à la fin du texte. L'utilisatrice peut corriger lors de la confirmation (US2).
